...
import { BlobShape } from '../shapes/primitives/BlobShape.js'; // Import the custom shape
import { StarShape } from '../shapes/primitives/StarShape.js';

class MyCustomNotationDiagram extends Diagram {
    constructor(container) {
        super(container); // Essential: calls the parent Diagram class constructor
