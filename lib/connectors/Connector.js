...
class Connector extends THREE.Mesh {
    ...
    setLabel(text, offsetY = 20) {
        ...
        // Safety guard: need at least 2 points to calculate a segment
        if (!this.points || this.points.length < 2) {
            console.warn(`Connector.setLabel: Cannot set label for connector ${this.elementId} because it has fewer than 2 points.`);
            return this;
        }
