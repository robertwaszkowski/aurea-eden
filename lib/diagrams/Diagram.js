            ...
            case 'ANALYZE':
                this.rotate(-65, () => {
                    ...
                    elementsWithValue.forEach(element => {
                        ...
                        // Initial Text with '0'
                        barElement.addWrappedText("0", textOffset, 12);
                        ...
                        textElement.position.z = 0 + 5; // Start at bottom + offset
