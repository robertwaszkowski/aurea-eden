...
import robotoRegular from '../shapes/text/Roboto_Regular.json';
                    ...
                    elementsWithValue.forEach(element => {
                        ...
                        const tween = new Tween(animationState)
                            ...
                            .onUpdate(() => {
                                ...
                                // Update Geometry
                                if (textElement.geometry) textElement.geometry.dispose();
                                textElement.geometry = new TextGeometry(currentValue.toString(), {
                                    font: font,
                                    size: 12,
                                    depth: .2,
                                    curveSegments: 12
