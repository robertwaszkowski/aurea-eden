            ...
            case 'ANALYZE':
                ...
                this.rotate(-65, () => {
                    ...
                    this.elements.forEach(element => {
                        if (element.texts && element.texts.length > 0) {
                            element.texts.forEach(textInfo => {
                                ...
                                // Re-apply rotation to face camera (handled globally but good to be safe)
                    ...
                    elementsWithValue.forEach(element => {
                        ...
                        // Initial Text with '0' (centered)
                        barElement.addWrappedText("0" + suffix, textOffset, 12, 'center');
