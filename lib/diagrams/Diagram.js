...
class Diagram {
    ...
    animateValueBarsOut(onComplete) {
        ...
        barsToAnimate.forEach(info => {
            ...
            const animationState = { progress: 1 }; // Start from current
            const startScaleZ = barElement.scale.z;
            const startSpriteZ = spriteLabel ? spriteLabel.position.z : 0;
            ...
            const tween = new Tween(animationState)
                ...
                .onUpdate(() => {
                    ...
                    if (spriteLabel) {
                        spriteLabel.position.z = startSpriteZ * p;
                    }
                })
                .onComplete(() => {
                    completedBars++;
    ...
    _initAnalyzeBars() {
        ...
        elementsWithValue.forEach(element => {
            ...
            const spriteLabel = barElement.addSpriteLabel("0", textOffset, {
                taskType: taskType,
                color: labelColor,
                bgColor: bubbleBg,
                borderColor: null,
            ...
            const tween = new Tween(animationState)
                ...
                .onUpdate(() => {
                    ...
                    barElement.updateSpriteLabel(spriteLabel, currentValue.toString(), dataColor.getStyle());
                })
                .start();
