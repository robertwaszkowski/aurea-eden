export const DiagramDimensions = {
    DISTANCE_BETWEEN_ELEMENTS: 80, // Best practice standard: 80 units for comfortable spacing
    SAFE_MARGIN: 30, // Distance for connectors to route around elements
};
...
export const Themes = {
    LIGHT: {
        BACKGROUND: 0xffffff,
        ELEMENT_STROKE: 0x333333,
        ELEMENT_TEXT: 0x333333,
        CONNECTOR: 0x333333,
        VALUE_BAR_OPACITY: 0.4,
        SEMANTIC_STROKE: {
            'task': 0x333333,
            'event': 0x333333,
            'start-event': 0x333333,
            'end-event': 0x333333,
            'gateway': 0x333333,
            'my-task': 0xffd700,
            'other-task': 0xc0c0c0,
            'annotation': 0x333333,
            'swimlane': 0xcccccc    // Light Grey for structural containers
        },
        SEMANTIC_TEXT: {
            'annotation': 0x333333,
            'flow': 0x333333,
            'swimlane': 0x666666    // Muted Dark Grey for Pool/Lane labels
        }
    },
    DARK: {
        ...
        SEMANTIC_STROKE: {
            ...
            'swimlane': 0x333333      // Muted Charcoal for structural containers
        },
        SEMANTIC_TEXT: {
            'annotation': 0xbbbbbb, // Muted Silver
            'flow': 0x888888,        // Muted Grey for logic labels
            'swimlane': 0x888888    // Muted Grey for Pool/Lane labels
