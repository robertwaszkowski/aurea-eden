...
class Element extends THREE.Mesh {
    ...
    static resolvePorts(sourceElement, targetElement, sourcePos, targetPos) {
        ...
        // If both are auto, use the angle-based fallback
        if (finalSrc === 'auto' && finalTgt === 'auto') {
            const ports = Element.determineAutoPorts(sourceElement, targetElement);
            finalSrc = ports.sourcePort;
            finalTgt = ports.targetPort;
