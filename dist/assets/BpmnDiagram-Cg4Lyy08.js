...
`,vn=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`,xn=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`,Nn=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`,_n=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`;var J={exports:{}},X;function On(){return X||(X=1,function(Y,o){var i=i||function(){var n=[];return{getAll:function(){return n},removeAll:function(){n=[]},add:function(d){n.push(d)},remove:function(d){var c=n.indexOf(d);c!==-1&&n.splice(c,1)},update:function(d,c){if(n.length===0)return!1;var p=0;for(d=d!==void 0?d:i.now();p<n.length;)n[p].update(d)||c?p++:n.splice(p,1);return!0}}}();typeof window>"u"&&typeof process<"u"?i.now=function(){var n=process.hrtime();return n[0]*1e3+n[1]/1e6}:typeof window<"u"&&window.performance!==void 0&&window.performance.now!==void 0?i.now=window.performance.now.bind(window.performance):Date.now!==void 0?i.now=Date.now:i.now=function(){return new Date().getTime()},i.Tween=function(n){var d=n,c={},p={},g={},u=1e3,f=0,E,C=!1,I=!1,N=0,x=null,z=i.Easing.Linear.None,M=i.Interpolation.Linear,b=[],L=null,T=!1,S=null,B=null,D=null;this.to=function(w,h){return p=w,h!==void 0&&(u=h),this},this.start=function(w){i.add(this),I=!0,T=!1,x=w!==void 0?w:i.now(),x+=N;for(var h in p){if(p[h]instanceof Array){if(p[h].length===0)continue;p[h]=[d[h]].concat(p[h])}d[h]!==void 0&&(c[h]=d[h],c[h]instanceof Array||(c[h]*=1),g[h]=c[h]||0)}return this},this.stop=function(){return I?(i.remove(this),I=!1,D!==null&&D.call(d,d),this.stopChainedTweens(),this):this},this.end=function(){return this.update(x+u),this},this.stopChainedTweens=function(){for(var w=0,h=b.length;w<h;w++)b[w].stop()},this.delay=function(w){return N=w,this},this.repeat=function(w){return f=w,this},this.repeatDelay=function(w){return E=w,this},this.yoyo=function(w){return C=w,this},this.easing=function(w){return z=w,this},this.interpolation=function(w){return M=w,this},this.chain=function(){return b=arguments,this},this.onStart=function(w){return L=w,this},this.onUpdate=function(w){return S=w,this},this.onComplete=function(w){return B=w,this},this.onStop=function(w){return D=w,this},this.update=function(w){var h,j,e;if(w<x)return!0;T===!1&&(L!==null&&L.call(d,d),T=!0),j=(w-x)/u,j=j>1?1:j,e=z(j);for(h in p)if(c[h]!==void 0){var s=c[h]||0,l=p[h];l instanceof Array?d[h]=M(l,e):(typeof l=="string"&&(l.charAt(0)==="+"||l.charAt(0)==="-"?l=s+parseFloat(l):l=parseFloat(l)),typeof l=="number"&&(d[h]=s+(l-s)*e))}if(S!==null&&S.call(d,e),j===1)if(f>0){isFinite(f)&&f--;for(h in g){if(typeof p[h]=="string"&&(g[h]=g[h]+parseFloat(p[h])),C){var r=g[h];g[h]=p[h],p[h]=r}c[h]=g[h]}return E!==void 0?x=w+E:x=w+N,!0}else{B!==null&&B.call(d,d);for(var a=0,t=b.length;a<t;a++)b[a].start(x+u);return!1}return!0}},i.Easing={Linear:{None:function(n){return n}},Quadratic:{In:function(n){return n*n},Out:function(n){return n*(2-n)},InOut:function(n){return(n*=2)<1?.5*n*n:-.5*(--n*(n-2)-1)}},Cubic:{In:function(n){return n*n*n},Out:function(n){return--n*n*n+1},InOut:function(n){return(n*=2)<1?.5*n*n*n:.5*((n-=2)*n*n+2)}},Quartic:{In:function(n){return n*n*n*n},Out:function(n){return 1- --n*n*n*n},InOut:function(n){return(n*=2)<1?.5*n*n*n*n:-.5*((n-=2)*n*n*n-2)}},Quintic:{In:function(n){return n*n*n*n*n},Out:function(n){return--n*n*n*n*n+1},InOut:function(n){return(n*=2)<1?.5*n*n*n*n*n:.5*((n-=2)*n*n*n*n+2)}},Sinusoidal:{In:function(n){return 1-Math.cos(n*Math.PI/2)},Out:function(n){return Math.sin(n*Math.PI/2)},InOut:function(n){return .5*(1-Math.cos(Math.PI*n))}},Exponential:{In:function(n){return n===0?0:Math.pow(1024,n-1)},Out:function(n){return n===1?1:1-Math.pow(2,-10*n)},InOut:function(n){return n===0?0:n===1?1:(n*=2)<1?.5*Math.pow(1024,n-1):.5*(-Math.pow(2,-10*(n-1))+2)}},Circular:{In:function(n){return 1-Math.sqrt(1-n*n)},Out:function(n){return Math.sqrt(1- --n*n)},InOut:function(n){return(n*=2)<1?-.5*(Math.sqrt(1-n*n)-1):.5*(Math.sqrt(1-(n-=2)*n)+1)}},Elastic:{In:function(n){return n===0?0:n===1?1:-Math.pow(2,10*(n-1))*Math.sin((n-1.1)*5*Math.PI)},Out:function(n){return n===0?0:n===1?1:Math.pow(2,-10*n)*Math.sin((n-.1)*5*Math.PI)+1},InOut:function(n){return n===0?0:n===1?1:(n*=2,n<1?-.5*Math.pow(2,10*(n-1))*Math.sin((n-1.1)*5*Math.PI):.5*Math.pow(2,-10*(n-1))*Math.sin((n-1.1)*5*Math.PI)+1)}},Back:{In:function(n){var d=1.70158;return n*n*((d+1)*n-d)},Out:function(n){var d=1.70158;return--n*n*((d+1)*n+d)+1},InOut:function(n){var d=2.5949095;return(n*=2)<1?.5*(n*n*((d+1)*n-d)):.5*((n-=2)*n*((d+1)*n+d)+2)}},Bounce:{In:function(n){return 1-i.Easing.Bounce.Out(1-n)},Out:function(n){return n<1/2.75?7.5625*n*n:n<2/2.75?7.5625*(n-=1.5/2.75)*n+.75:n<2.5/2.75?7.5625*(n-=2.25/2.75)*n+.9375:7.5625*(n-=2.625/2.75)*n+.984375},InOut:function(n){return n<.5?i.Easing.Bounce.In(n*2)*.5:i.Easing.Bounce.Out(n*2-1)*.5+.5}}},i.Interpolation={Linear:function(n,d){var c=n.length-1,p=c*d,g=Math.floor(p),u=i.Interpolation.Utils.Linear;return d<0?u(n[0],n[1],p):d>1?u(n[c],n[c-1],c-p):u(n[g],n[g+1>c?c:g+1],p-g)},Bezier:function(n,d){for(var c=0,p=n.length-1,g=Math.pow,u=i.Interpolation.Utils.Bernstein,f=0;f<=p;f++)c+=g(1-d,p-f)*g(d,f)*n[f]*u(p,f);return c},CatmullRom:function(n,d){var c=n.length-1,p=c*d,g=Math.floor(p),u=i.Interpolation.Utils.CatmullRom;return n[0]===n[c]?(d<0&&(g=Math.floor(p=c*(1+d))),u(n[(g-1+c)%c],n[g],n[(g+1)%c],n[(g+2)%c],p-g)):d<0?n[0]-(u(n[0],n[0],n[1],n[1],-p)-n[0]):d>1?n[c]-(u(n[c],n[c],n[c-1],n[c-1],p-c)-n[c]):u(n[g?g-1:0],n[g],n[c<g+1?c:g+1],n[c<g+2?c:g+2],p-g)},Utils:{Linear:function(n,d,c){return(d-n)*c+n},Bernstein:function(n,d){var c=i.Interpolation.Utils.Factorial;return c(n)/c(d)/c(n-d)},Factorial:function(){var n=[1];return function(d){var c=1;if(n[d])return n[d];for(var p=d;p>1;p--)c*=p;return n[d]=c,c}}(),CatmullRom:function(n,d,c,p,g){var u=(c-n)*.5,f=(p-d)*.5,E=g*g,C=g*E;return(2*d-2*c+u+f)*C+(-3*d+3*c-2*u-f)*E+u*g+d}}},function(n){Y.exports=i}()}(J)),J.exports}On();class m extends nn{constructor(o){super(o)}static get Dimensions(){return{DISTANCE_BETWEEN_ELEMENTS:en.DISTANCE_BETWEEN_ELEMENTS,START_EVENT_LINE_WIDTH:1,END_EVENT_LINE_WIDTH:2.4,ICON_SIZE_SMALL:10,ICON_SIZE_MEDIUM:18,ICON_SIZE_LARGE:30}}addStartEvent(o){return this.addElement(new k(o,new v))}addMessageStartEvent(o){return this.addElement(new k(o,new v)).addIcon(Mn,"center",m.Dimensions.ICON_SIZE_MEDIUM)}addTimerStartEvent(o){return this.addElement(new k(o,new v)).addIcon(Rn,"center",m.Dimensions.ICON_SIZE_LARGE)}addConditionalStartEvent(o){return this.addElement(new k(o,new v)).addIcon(vn,"center",m.Dimensions.ICON_SIZE_MEDIUM)}addSignalStartEvent(o){return this.addElement(new k(o,new v)).addIcon(Fn,"center",m.Dimensions.ICON_SIZE_MEDIUM)}addIntermediateEvent(o){return this.addElement(new k(o,new v)).addIcon(En,"center",m.Dimensions.ICON_SIZE_LARGE)}addIntermediateMessageCatchEvent(o){return this.addElement(new k(o,new v)).addIcon(Tn,"center",m.Dimensions.ICON_SIZE_LARGE)}addIntermediateMessageThrowEvent(o){return this.addElement(new k(o,new v)).addIcon(Sn,"center",m.Dimensions.ICON_SIZE_LARGE)}addIntermediateTimerEvent(o){return this.addElement(new k(o,new v)).addIcon(jn,"center",m.Dimensions.ICON_SIZE_LARGE)}addIntermediateEscalationEvent(o){return this.addElement(new k(o,new v)).addIcon(In,"center",m.Dimensions.ICON_SIZE_LARGE)}addIntermediateConditionalEvent(o){return this.addElement(new k(o,new v)).addIcon(Cn,"center",m.Dimensions.ICON_SIZE_LARGE)}addIntermediateLinkCatchEvent(o){return this.addElement(new k(o,new v)).addIcon(Nn,"center",m.Dimensions.ICON_SIZE_LARGE)}addIntermediateLinkThrowEvent(o){return this.addElement(new k(o,new v)).addIcon(Ln,"center",m.Dimensions.ICON_SIZE_LARGE)}addIntermediateCompensationEvent(o){return this.addElement(new k(o,new v)).addIcon(bn,"center",m.Dimensions.ICON_SIZE_LARGE)}addIntermediateSignalCatchEvent(o){return this.addElement(new k(o,new v)).addIcon(Bn,"center",m.Dimensions.ICON_SIZE_LARGE)}addIntermediateSignalThrowEvent(o){return this.addElement(new k(o,new v)).addIcon(Dn,"center",m.Dimensions.ICON_SIZE_LARGE)}addEndEvent(o){return this.addElement(new k(o,new v(m.Dimensions.END_EVENT_LINE_WIDTH)))}addMessageEndEvent(o){return this.addElement(new k(o,new v(m.Dimensions.END_EVENT_LINE_WIDTH))).addIcon(zn,"center",m.Dimensions.ICON_SIZE_MEDIUM)}addEscalationEndEvent(o){return this.addElement(new k(o,new v(m.Dimensions.END_EVENT_LINE_WIDTH))).addIcon(xn,"center",m.Dimensions.ICON_SIZE_MEDIUM)}addErrorEndEvent(o){return this.addElement(new k(o,new v(m.Dimensions.END_EVENT_LINE_WIDTH))).addIcon(yn,"center",m.Dimensions.ICON_SIZE_MEDIUM)}addCompensateEndEvent(o){return this.addElement(new k(o,new v(m.Dimensions.END_EVENT_LINE_WIDTH))).addIcon(fn,"center",m.Dimensions.ICON_SIZE_MEDIUM)}addSignalEndEvent(o){return this.addElement(new k(o,new v(m.Dimensions.END_EVENT_LINE_WIDTH))).addIcon(An,"center",m.Dimensions.ICON_SIZE_MEDIUM)}addTerminateEndEvent(o){return this.addElement(new k(o,new v(m.Dimensions.END_EVENT_LINE_WIDTH))).addIcon(_n,"center",m.Dimensions.ICON_SIZE_MEDIUM)}addTask(o){return this.addElement(new k(o,new F))}addManualTask(o){return this.addElement(new k(o,new F)).addIcon(an,"top-left",m.Dimensions.ICON_SIZE_SMALL)}addUserTask(o){return this.addElement(new k(o,new F)).addIcon(rn,"top-left",m.Dimensions.ICON_SIZE_SMALL)}addScriptTask(o){return this.addElement(new k(o,new F)).addIcon(dn,"top-left",m.Dimensions.ICON_SIZE_SMALL)}addBusinessRuleTask(o){return this.addElement(new k(o,new F)).addIcon(cn,"top-left",m.Dimensions.ICON_SIZE_SMALL)}addServiceTask(o){return this.addElement(new k(o,new F)).addIcon(ln,"top-left",m.Dimensions.ICON_SIZE_SMALL)}addSendTask(o){return this.addElement(new k(o,new F)).addIcon(pn,"top-left",m.Dimensions.ICON_SIZE_SMALL)}addReceiveTask(o){return this.addElement(new k(o,new F)).addIcon(gn,"top-left",m.Dimensions.ICON_SIZE_SMALL)}addGateway(o){return this.addExclusiveGateway(o)}addInclusiveGateway(o){return this.addElement(new k(o,new V)).addIcon(mn,"center",m.Dimensions.ICON_SIZE_LARGE)}addExclusiveGateway(o){return this.addElement(new k(o,new V)).addIcon(wn,"center",m.Dimensions.ICON_SIZE_MEDIUM)}addParallelGateway(o){return this.addElement(new k(o,new V)).addIcon(hn,"center",m.Dimensions.ICON_SIZE_LARGE)}addEventBasedGateway(o){return this.addElement(new k(o,new V)).addIcon(kn,"center",m.Dimensions.ICON_SIZE_LARGE)}addComplexGateway(o){return this.addElement(new k(o,new V)).addIcon(un,"center",m.Dimensions.ICON_SIZE_MEDIUM)}addFlowConnector(o,i){return this.addConnector(new tn(o,new on(i)))}import(o){if(!o){console.error("No file provided for import.");return}const i=new FileReader;i.onload=n=>{if(o.name.endsWith(".bpmn")){const c=new DOMParser().parseFromString(n.target.result,"text/xml");console.log(c),this.buildDiagram(c)}else console.warn("File format not supported.")},i.readAsText(o)}buildDiagram(o){const i="http://www.omg.org/spec/BPMN/20100524/MODEL",n="http://www.omg.org/spec/BPMN/20100524/DI",d="http://www.omg.org/spec/DD/20100524/DC",c="http://www.omg.org/spec/DD/20100524/DI",p=o.getElementsByTagNameNS(i,"startEvent");for(let e=0;e<p.length;e++){const s=p[e].getAttribute("id");console.log("startEventId:",s);const l=p[e].getElementsByTagNameNS(i,"name");console.log("name:",l);const r=p[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=p[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);p[e].getElementsByTagNameNS(i,"messageEventDefinition").length>0?this.addMessageStartEvent(s):p[e].getElementsByTagNameNS(i,"timerEventDefinition").length>0?this.addTimerStartEvent(s):p[e].getElementsByTagNameNS(i,"conditionalEventDefinition").length>0?this.addConditionalStartEvent(s):p[e].getElementsByTagNameNS(i,"signalEventDefinition").length>0?this.addSignalStartEvent(s):this.addStartEvent(s)}const g=o.getElementsByTagNameNS(i,"endEvent");for(let e=0;e<g.length;e++){const s=g[e].getAttribute("id");console.log("endEventId:",s);const l=g[e].getElementsByTagNameNS(i,"name");console.log("name:",l);const r=g[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=g[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);g[e].getElementsByTagNameNS(i,"messageEventDefinition").length>0?this.addMessageEndEvent(s):g[e].getElementsByTagNameNS(i,"escalationEventDefinition").length>0?this.addEscalationEndEvent(s):g[e].getElementsByTagNameNS(i,"errorEventDefinition").length>0?this.addErrorEndEvent(s):g[e].getElementsByTagNameNS(i,"compensateEventDefinition").length>0?this.addCompensateEndEvent(s):g[e].getElementsByTagNameNS(i,"signalEventDefinition").length>0?this.addSignalEndEvent(s):g[e].getElementsByTagNameNS(i,"terminateEventDefinition").length>0?this.addTerminateEndEvent(s):this.addEndEvent(s)}const u=o.getElementsByTagNameNS(i,"intermediateCatchEvent");for(let e=0;e<u.length;e++){const s=u[e].getAttribute("id");console.log("intermediateCatchEventId:",s);const l=u[e].getElementsByTagNameNS(i,"name");console.log("name:",l);const r=u[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=u[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);u[e].getElementsByTagNameNS(i,"messageEventDefinition").length>0?this.addIntermediateMessageCatchEvent(s):u[e].getElementsByTagNameNS(i,"timerEventDefinition").length>0?this.addIntermediateTimerEvent(s):u[e].getElementsByTagNameNS(i,"conditionalEventDefinition").length>0?this.addIntermediateConditionalEvent(s):u[e].getElementsByTagNameNS(i,"linkEventDefinition").length>0?this.addIntermediateLinkCatchEvent(s):u[e].getElementsByTagNameNS(i,"signalEventDefinition").length>0?this.addIntermediateSignalCatchEvent(s):this.addIntermediateEvent(s)}const f=o.getElementsByTagNameNS(i,"intermediateThrowEvent");for(let e=0;e<f.length;e++){const s=f[e].getAttribute("id");console.log("intermediateThrowEventId:",s);const l=f[e].getElementsByTagNameNS(i,"name");console.log("name:",l);const r=f[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=f[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);f[e].getElementsByTagNameNS(i,"messageEventDefinition").length>0?this.addIntermediateMessageThrowEvent(s):f[e].getElementsByTagNameNS(i,"escalationEventDefinition").length>0?this.addIntermediateEscalationEvent(s):f[e].getElementsByTagNameNS(i,"linkEventDefinition").length>0?this.addIntermediateLinkThrowEvent(s):f[e].getElementsByTagNameNS(i,"compensateEventDefinition").length>0?this.addIntermediateCompensationEvent(s):f[e].getElementsByTagNameNS(i,"signalEventDefinition").length>0?this.addIntermediateSignalThrowEvent(s):this.addIntermediateEvent(s)}const E=o.getElementsByTagNameNS(i,"task");for(let e=0;e<E.length;e++){const s=E[e].getAttribute("id");console.log("taskId:",s);const l=E[e].getAttribute("name");console.log("name:",l);const r=E[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=E[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addTask(s).addWrappedText(l)}const C=o.getElementsByTagNameNS(i,"manualTask");for(let e=0;e<C.length;e++){const s=C[e].getAttribute("id");console.log("manualTaskId:",s);const l=C[e].getAttribute("name");console.log("name:",l);const r=C[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=C[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addManualTask(s).addWrappedText(l)}const I=o.getElementsByTagNameNS(i,"userTask");for(let e=0;e<I.length;e++){const s=I[e].getAttribute("id");console.log("userTaskId:",s);const l=I[e].getAttribute("name");console.log("name:",l);const r=I[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=I[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addUserTask(s).addWrappedText(l)}const N=o.getElementsByTagNameNS(i,"scriptTask");for(let e=0;e<N.length;e++){const s=N[e].getAttribute("id");console.log("scriptTaskId:",s);const l=N[e].getAttribute("name");console.log("name:",l);const r=N[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=N[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addScriptTask(s).addWrappedText(l)}const x=o.getElementsByTagNameNS(i,"businessRuleTask");for(let e=0;e<x.length;e++){const s=x[e].getAttribute("id");console.log("businessRuleTaskId:",s);const l=x[e].getAttribute("name");console.log("name:",l);const r=x[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=x[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addBusinessRuleTask(s).addWrappedText(l)}const z=o.getElementsByTagNameNS(i,"serviceTask");for(let e=0;e<z.length;e++){const s=z[e].getAttribute("id");console.log("serviceTaskId:",s);const l=z[e].getAttribute("name");console.log("name:",l);const r=z[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=z[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addServiceTask(s).addWrappedText(l)}const M=o.getElementsByTagNameNS(i,"sendTask");for(let e=0;e<M.length;e++){const s=M[e].getAttribute("id");console.log("sendTaskId:",s);const l=M[e].getAttribute("name");console.log("name:",l);const r=M[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=M[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addSendTask(s).addWrappedText(l)}const b=o.getElementsByTagNameNS(i,"receiveTask");for(let e=0;e<b.length;e++){const s=b[e].getAttribute("id");console.log("receiveTaskId:",s);const l=b[e].getAttribute("name");console.log("name:",l);const r=b[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=b[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addReceiveTask(s).addWrappedText(l)}const L=o.getElementsByTagNameNS(i,"inclusiveGateway");for(let e=0;e<L.length;e++){const s=L[e].getAttribute("id");console.log("gatewayId:",s);const l=L[e].getAttribute("name");console.log("name:",l);const r=L[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=L[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addInclusiveGateway(s)}const T=o.getElementsByTagNameNS(i,"exclusiveGateway");for(let e=0;e<T.length;e++){const s=T[e].getAttribute("id");console.log("gatewayId:",s);const l=T[e].getAttribute("name");console.log("name:",l);const r=T[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=T[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addExclusiveGateway(s)}const S=o.getElementsByTagNameNS(i,"parallelGateway");for(let e=0;e<S.length;e++){const s=S[e].getAttribute("id");console.log("gatewayId:",s);const l=S[e].getAttribute("name");console.log("name:",l);const r=S[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=S[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addParallelGateway(s)}const B=o.getElementsByTagNameNS(i,"eventBasedGateway");for(let e=0;e<B.length;e++){const s=B[e].getAttribute("id");console.log("gatewayId:",s);const l=B[e].getAttribute("name");console.log("name:",l);const r=B[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=B[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addEventBasedGateway(s)}const D=o.getElementsByTagNameNS(i,"complexGateway");for(let e=0;e<D.length;e++){const s=D[e].getAttribute("id");console.log("gatewayId:",s);const l=D[e].getAttribute("name");console.log("name:",l);const r=D[e].getElementsByTagNameNS(i,"incoming");console.log("incoming:",r);for(let t=0;t<r.length;t++)console.log("incoming:",r[t].textContent);const a=D[e].getElementsByTagNameNS(i,"outgoing");console.log("outgoing:",a);for(let t=0;t<a.length;t++)console.log("outgoing:",a[t].textContent);this.addComplexGateway(s)}const w=o.getElementsByTagNameNS(i,"sequenceFlow");for(let e=0;e<w.length;e++){const s=w[e].getAttribute("id");console.log("sequenceFlowId:",s);const l=w[e].getAttribute("name");console.log("name:",l);const r=w[e].getAttribute("sourceRef");console.log("sourceRef:",r);const a=w[e].getAttribute("targetRef");console.log("targetRef:",a)}const h=o.getElementsByTagNameNS(n,"BPMNShape");for(let e=0;e<h.length;e++){const s=h[e],l=s.getAttribute("id"),r=s.getAttribute("bpmnElement"),a=s.getElementsByTagNameNS(d,"Bounds")[0];if(a){const t=parseFloat(a.getAttribute("x")),W=parseFloat(a.getAttribute("y"))*-1,R=parseFloat(a.getAttribute("width")),O=parseFloat(a.getAttribute("height"));console.log(`BPMNShape: ${l}, ${r}, x: ${t}, y: ${W}, width: ${R}, height: ${O}`);const P=new q(t+R/2,W-O/2,0),U=this.getElementById(r);U?U.positionAt(P):console.warn(`Element with id ${r} not found.`);let _,G,y,Z;const $=s.getElementsByTagNameNS(n,"BPMNLabel");if($.length>0){const A=$[0].getElementsByTagNameNS(d,"Bounds")[0];if(A){_=parseFloat(A.getAttribute("x")),G=parseFloat(A.getAttribute("y"))*-1,y=parseFloat(A.getAttribute("width")),Z=parseFloat(A.getAttribute("height")),console.log(`Label position (Shape): x: ${_}, y: ${G}, width: ${y}, height: ${Z}`);const H=o.getElementById(r).getAttribute("name");if(console.log(`bpmnElementName: ${H}`),H){const K=new q(_+y/2,G-Z/2,0);this.addElement(new k("t1",new Q(H))).positionAt(K)}}}}}const j=o.getElementsByTagNameNS(n,"BPMNEdge");for(let e=0;e<j.length;e++){const s=j[e],l=s.getAttribute("id"),r=s.getAttribute("bpmnElement"),a=Array.from(w).find(y=>y.getAttribute("id")===r),t=a?a.getAttribute("name"):null,W=s.getElementsByTagNameNS(c,"waypoint"),R=[];for(let y=0;y<W.length;y++){const Z=W[y],$=parseFloat(Z.getAttribute("x")),A=parseFloat(Z.getAttribute("y"))*-1;R.push(new sn($,A)),console.log(`BPMNEdge: ${r}, x: ${$}, y: ${A}`)}console.log("connectorPoints:",R),this.addConnector(this.addFlowConnector(l,R));let O,P,U,_;const G=s.getElementsByTagNameNS(n,"BPMNLabel");if(G.length>0){const y=G[0].getElementsByTagNameNS(d,"Bounds")[0];y&&(O=parseFloat(y.getAttribute("x")),P=parseFloat(y.getAttribute("y"))*-1,U=parseFloat(y.getAttribute("width")),_=parseFloat(y.getAttribute("height")),console.log(`Label position: x: ${O}, y: ${P}, width: ${U}, height: ${_}`))}if(t){const y=new q(O+U/2,P-_/2,0);this.addElement(new k("t1",new Q(t))).positionAt(y)}}this.arrange()}}export{m as B};
